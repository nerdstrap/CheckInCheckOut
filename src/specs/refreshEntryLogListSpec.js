define(function (require) {
    ...
    describe('refresh entryLogList', function () {
        var self = this;
        ...
        it('should update the collection', function (done) {
            ...
            //act
            var promise = self.entryLogSearchControllerInstance.refreshEntryLogList(mockEntryLogCollectionInstance, fakeOptions);
